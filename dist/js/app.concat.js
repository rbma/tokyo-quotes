...
}(jQuery));;(function(){"use strict";var e;e=angular.module("quotes",["ngRoute","ngSanitize","ng-contentful","ngAnimate","quoteControllers","quoteDirectives","quoteServices"]),e.config(["$routeProvider","$locationProvider","contentfulClientProvider",function(e,t,n){return e.when("/",{templateUrl:"partials/index.html",controller:"IndexCtrl"}).otherwise({redirectTo:"/"}),n.setSpaceId("4xlwm16911zp"),n.setAccessToken("6fe66430d43042a7c28777422e4ae6f8edf5f58bf05d46a072e92a83bf432dab")}])}).call(this);;(function(){"use strict";var e;e=angular.module("quoteControllers",[]),e.controller("IndexCtrl",["$scope","$http","$sce","contentfulClient",function(e,t,n,o){var r,l;return r=new Showdown.converter,e.body={},e.videoStopped=!1,e.begin=!0,e.player={},e.background={},l=0,e.playing=!1,e.showInfo=!1,e.playerVars={controls:0,autoplay:0,modestbranding:1,showinfo:0,hd:1},e.$on("youtube.player.ready",function(t,n){return e.player=n}),e.$on("youtube.player.ended",function(t,n){return e.playing=!1,e.showInfo=!0}),e.$watch("playing",function(e){return console.log(e)}),e.$watch("background",function(e){}),o.entries({content_type:"3NIaEMnF5CcQOCUeUaGESy",include:1}).then(function(t){var o,l,a,i,u;for(e.data=t[0],e.body=e.data.fields,console.log(e.body),e.background=e.body.bodyImage.fields.file.url,u=e.body.individualQuote,a=0,i=u.length;i>a;a++)o=u[a],o.fields.artistText=r.makeHtml(o.fields.artistText);return l=e.body.individualQuote,e.current=l[0],e.launchVid=function(t){var n;return e.playing=!0,n=t.fields.youtubeId,e.player.loadVideoById(n),e.player.playVideo(),e.titleName=t.fields.titleName,e.artistText=t.fields.artistText,e.player.seekTo(28)},e.closeInfo=function(){return e.showInfo=!1},e.updateInfo=function(t){return e.current=t},e.trust=function(e){return n.trustAsHtml(e)}})}])}).call(this);;(function(){"use strict";var n;n=angular.module("quoteDirectives",[]),n.directive("lazy",function(){var n;return n=function(n,e,r){var i;return i=r.videoid,e.data("youtube-id",i),e.lazyYT()},{link:n}}),n.directive("slide",["$window",function(n){var e;return e=function(e,r,i){var t,u,o,c,a,d,s,l;return t=i.image,u=new Image,u.src=t,c=u.width,o=u.height,s=c/o,a=.2*n.innerWidth,l=function(){var e,r,i,o,c;return i=n.innerHeight,o=n.innerWidth,console.log("called"),700>i&&(i=700),u=new Image,u.src=t,u.height=i,u.width=i*s,c=$(".image-wrapper").width(),e=u.width-c,r=e/2,a=.2*o,$(".panoram").css({background:"url("+u.src+") no-repeat center center",backgroundSize:"cover",width:1.1*u.width+"px",height:1.1*i+"px",left:1.5*-r+"px"})},r.bind("mousemove",function(n){return d(n)}),d=function(n){var e,i;return e=1.5*-n.clientX,i=.1*-n.clientY,r.css({left:""+e+"px",top:""+i+"px"})},l(),$(window).bind("resize",function(n){return l()}),n.blur(function(){return l()}),n.focus(function(){return l()})},{scope:{control:"="},link:e}}]),n.directive("hoverPic",function(){var n,e;return e=function(n){var e,r;return e=2*n.clientX,r=2*n.clientY,$(".frame").css({backgroundPosition:""+e+"px "+r+"px"})},n=function(n,r,i){return r.unbind("mouseenter"),r.bind("mouseenter",function(){var n;return n=i.img,$(".frame").css({background:"url("+n+")"}),$(".image-wrapper").hide()}),r.unbind("mouseleave"),r.bind("mouseleave",function(){return $(".frame").css({background:"black"}),$(".image-wrapper").show()}),r.bind("mousemove",function(n){return e(n)})},{link:n}})}).call(this);;(function(){"use strict";var e;e=angular.module("quoteServices",[])}).call(this);